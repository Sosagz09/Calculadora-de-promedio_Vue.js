...
- ✅ Campos con colores según la nota ingresada
- ✅ Desglose de contribución por cada bloque
- ✅ Botón para limpiar y calcular de nuevo
- ✅ Diseño responsivo adaptable a cualquier dispositivo
- ✅ Interfaz con identidad visual de la UGB
...
> Ambas librerías se cargan mediante **CDN**, no requiere instalación.
...
```bash
git clone https://github.com/tu-usuario/calculadora-promedio-ugb.git
```
